...
<html>
	<head>
		<title>Aqualis - Actualités Environnement</title>
		<meta charset="UTF-8">
		...
		<div class="container">
			...
			<div id="contenu">
				<div class="titre groupe">
					<h1>Actualités environnementales</h1>
				</div>
				...
				<?php
					...
					$query = 	"SELECT *
								...
								WHERE (post_author = user_id) AND (post_category = cat_id) AND (post_pic = pict_id) AND `projet1a_posts`.`post_category` = 2
